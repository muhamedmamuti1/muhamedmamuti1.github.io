export const heroHighlights = [
  { label: 'Technologies', value: 'Java · Kotlin · Node.js' },
  { label: 'Experience', value: '4+ years shipping production systems' },
  { label: 'Collaboration', value: 'Startups, enterprise & academia' },
]
...
export const contactChannels = [
  {
    label: 'Email',
    value: 'muhamedmamuti1999@gmail.com',
    href: 'mailto:muhamedmamuti1999@gmail.com',
  },
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/muhamed-mamuti',
    href: 'https://www.linkedin.com/in/muhamed-mamuti',
  },
  {
    label: 'Phone',
